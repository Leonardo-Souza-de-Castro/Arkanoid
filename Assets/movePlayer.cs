...
public class movePlayer : MonoBehaviour
{
    ...
    public float maxX = 7.27f;
    public float minX = 1.57f;
    ...
    void Update()
    {
        ...
        if (pos.x > maxX) {                  
            pos.x = maxX;                     // Corrige a posicao da raquete caso ele ultrapasse o limite superior
        }
        else if (pos.x < minX) {
            pos.x = minX;                    // Corrige a posicao da raquete caso ele ultrapasse o limite inferior
        }
